...
//
let DBins = 'INSdb'
let colection = 'PENETROMETERmain'
//
...
router.post('/register_PENETROMETER', async (req, res) => {
...
router.post('/PENETROMETER_REJ', async (req, res) => {

    console.log("--PENETROMETER_REJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/PENETROMETER_SEND_DATA', async (req, res) => {

    console.log("--PENETROMETER_SEND_DATA--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/PENETROMETER_SEND_DATA_ADJ', async (req, res) => {

    console.log("--PENETROMETER_SEND_DATA_ADJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/PENETROMETER_Result', async (req, res) => {
