...
router.post('/register_FA', async (req, res) => {
...
router.post('/FA_REJ', async (req, res) => {
...
router.post('/FA_SEND_DATA', async (req, res) => {

  console.log("--FA_SEND_DATA--");
  //-------------------------------------
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
...
router.post('/FA_SEND_DATA_ADJ', async (req, res) => {

    console.log("--FA_SEND_DATA_ADJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/FA_Result', async (req, res) => {
