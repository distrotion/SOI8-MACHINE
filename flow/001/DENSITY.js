...
router.post('/register_DENSITY', async (req, res) => {
...
router.post('/DENSITY_REJ', async (req, res) => {

  console.log("--DENSITY_REJ--");
  //-------------------------------------
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
...
router.post('/DENSITY_SEND_DATA', async (req, res) => {

  console.log("--DENSITY_SEND_DATA--");
  //-------------------------------------
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
...
router.post('/DENSITY_SEND_DATA_ADJ', async (req, res) => {

    console.log("--DENSITY_SEND_DATA_ADJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
