...
router.post('/register_ECm', async (req, res) => {
...
router.post('/ECm_REJ', async (req, res) => {
...
router.post('/ECm_SEND_DATA', async (req, res) => {

    console.log("--ECm_SEND_DATA--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/ECm_SEND_DATA_ADJ', async (req, res) => {

    console.log("--ECm_SEND_DATA_ADJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/ECm_Result', async (req, res) => {
