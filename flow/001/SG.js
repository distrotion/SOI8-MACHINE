...
router.post('/register_SG', async (req, res) => {
...
router.post('/SG_REJ', async (req, res) => {
...
router.post('/SG_SEND_DATA', async (req, res) => {

  console.log("--SG_SEND_DATA--");
  //-------------------------------------
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
...
router.post('/SG_SEND_DATA_ADJ', async (req, res) => {

    console.log("--SG_SEND_DATA_ADJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/SG_Result', async (req, res) => {
