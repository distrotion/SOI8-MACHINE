...
router.post('/register_MINIAV', async (req, res) => {
...
router.post('/MINIAV_REJ', async (req, res) => {

    console.log("--MINIAV_REJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/MINIAV_SEND_DATA', async (req, res) => {

    console.log("--MINIAV_SEND_DATA--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/MINIAV_SEND_DATA_ADJ', async (req, res) => {

    console.log("--MINIAV_SEND_DATA_ADJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/MINIAV_Result', async (req, res) => {
