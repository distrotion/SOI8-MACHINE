...
router.post('/register_BOOKFEILD', async (req, res) => {
...
router.post('/BOOKFEILD_REJ', async (req, res) => {

    console.log("--BOOKFEILD_REJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/BOOKFEILD_SEND_DATA', async (req, res) => {

    console.log("--BOOKFEILD_SEND_DATA--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/BOOKFEILD_SEND_DATA_ADJ', async (req, res) => {

    console.log("--BOOKFEILD_SEND_DATA_ADJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/BOOKFEILD_Result', async (req, res) => {
