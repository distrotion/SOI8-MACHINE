...
router.post('/register_AUTOTITRATE', async (req, res) => {
...
router.post('/AUTOTITRATE_REJ', async (req, res) => {

    console.log("--AUTOTITRATE_REJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/AUTOTITRATE_SEND_DATA', async (req, res) => {

    console.log("--AUTOTITRATE_SEND_DATA--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/AUTOTITRATE_SEND_DATA_ADJ', async (req, res) => {

    console.log("--AUTOTITRATE_SEND_DATA_ADJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/AUTOTITRATE_Result', async (req, res) => {
