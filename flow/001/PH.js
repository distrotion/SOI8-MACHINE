...
router.post('/register_PH', async (req, res) => {
...
router.post('/PH_REJ', async (req, res) => {
...
router.post('/PH_SEND_DATA', async (req, res) => {
...
router.post('/PH_SEND_DATA_ADJ', async (req, res) => {

    console.log("--PH_SEND_DATA_ADJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/PH_Result', async (req, res) => {
