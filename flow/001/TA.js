...
router.post('/register_TA', async (req, res) => {
...
router.post('/TA_REJ', async (req, res) => {
...
router.post('/TA_SEND_DATA', async (req, res) => {

  console.log("--TA_SEND_DATA--");
  //-------------------------------------
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
...
router.post('/TA_SEND_DATA_ADJ', async (req, res) => {

    console.log("--TA_SEND_DATA_ADJ--");
    //-------------------------------------
    console.log(req.body);
    let input = req.body;
    //-------------------------------------
...
router.post('/TA_Result', async (req, res) => {
